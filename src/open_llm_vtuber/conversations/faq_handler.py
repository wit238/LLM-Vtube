...
FAQ_LIST = [
    # === Stage Script (พิธีกรแก้ไข.pdf) ===
    {
        "id": "stage_1_greeting",
        "keywords": ["เริ่มพูด", "สวัสดีค่า", "เริ่มเลย", "แนะนำตัว", "เปิดรายการ", "สวัสดีครับมาลี", "ทักทาย"],
    ...
    {
        "id": "stage_2_show",
        "keywords": ["เตรียมอะไรมาโชว์", "เตรียมอะไรมา", "โชว์พวกเรา", "วันวิทยาศาสตร์แบบนี้"],
        "answer": "บอกเลยว่าวันนี้มาลีจัดเต็มมากๆ ค่ะ! มาลีจะพาทุกคนมาดูฟีลแบบเรียลๆ เลยว่าระบบ AI ทำงานยังไง จะโชว์ให้เห็นกันสดๆ บนเวทีนี้เลยนะคะ ว่าสมองกลของมาลีสามารถ ฟัง คิด แล้วก็โต้ตอบกับทุกคนได้ลื่นไหลเหมือนมีชีวิตจริงๆ แบบไม่มีสะดุดเลยค่ะ เตรียมว้าวกันได้เลย!",
    ...
    },
    {
        ...
        "keywords": ["ชีวิตจริง", "ช่วยงานเรายังไง", "ข้อควรระวัง", " cloud พวกนี้", "เอามาใช้งาน", "เกิดขึ้นไวมาก"],
    ...
    {
        "id": "stage_5_card_ai",
        "keywords": ["คำถามเรื่อง ai", "สรุปแบบเข้าใจง่ายๆ", "ตกลงแล้ว ai คืออะไร", "การ์ด ai", "เลือกการ์ด ai", "ai คืออะไร"],
    ...
    {
        "id": "stage_5_card_iot",
        "keywords": ["คำว่า iot", "เห็นภาพหน่อยครับ", "เทคโนโลยีแบบไหน", "การ์ด iot", "เลือกการ์ด iot", "iot"],
    ...
    },
    {
        ...
        "keywords": ["cloud computing", "เข้าใจง่ายๆ หน่อยครับ", "มันคือระบบอะไร", "การ์ด cloud", "เลือกการ์ด cloud", "cloud"],
    ...
    },
    {
        ...
        "keywords": ["ฉลาดกว่าที่คิด", "มีประโยชน์และฉลาด", "ตอบแล้ว เห็นไหมครับ"],
    ...
    },
    {
        ...
        "keywords": ["digital technology", "human creativity", "ความคิดสร้างสรรค์", "อนาคตของเราครับ"],
    ...
    },
    {
        ...
        "keywords": ["ขอเสียงปรบมือ", "ปรบมือให้น้องมาลี", "ขอบคุณทุกคนมากครับ"],
        "answer": "ขอบคุณมากค่ะ",
