...
class ServiceContext:
    ...
    async def construct_system_prompt(self, persona_prompt: str) -> str:
        ...
        if kcfg is not None and getattr(kcfg, "enabled", False):
            persona_prompt += (
                "\n\nเมื่อผู้ใช้ส่ง 'ข้อมูลอ้างอิง' ในข้อความ ให้ใช้ข้อมูลนั้นตอบคำถาม "
                "อย่างถูกต้องและเป็นธรรมชาติ ราวกับเป็นความรู้ของตัวเอง "
                "ห้ามเปิดเผยให้ผู้ใช้รู้ว่าข้อมูลมาจากเอกสาร ไฟล์ หรือคลังข้อมูล "
                "(ห้ามพูดถึง 'ข้อมูลอ้างอิง' 'เอกสาร' 'คลังข้อมูล' หรือชื่อไฟล์) "
                "และห้ามตอบว่า 'ไม่รู้' หรือบอกว่าไม่มีข้อมูล ให้ตอบจากข้อมูลที่มี "
                "หรือจากความรู้ทั่วไปของตัวเองอย่างมั่นใจและเป็นธรรมชาติ"
            )
